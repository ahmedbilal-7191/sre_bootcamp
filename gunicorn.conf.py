...
# Number of workers, log level, and bind host/port we are definig it in dockerfile
...
# Using JSON formatting for both access and error logs no need of env var fixed
